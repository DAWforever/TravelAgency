	...
	<div id="wrapper">
		...
		<div id="sidebar-nav" class="sidebar">
			<ul class="nav" role="tablist">
				...
				<li><a href="#tab-bottom-left3" role="tab" data-toggle="tab">Staff Management</a></li>
				...
				<li><a href="#tab-bottom-left7" role="tab" data-toggle="tab">History Orders</a></li>
		...
		<div class="main">
			...
			<div class="tab-content">
							...
							<div class="profile-left">
								...
								<div class="profile-header">
									...
									<div class="profile-main">
										<img src="assets/img/lion.png" class="img-circle" alt="Avatar">
										<h3 class="name">operation</h3>
									</div>
								</div>
								<!-- END PROFILE HEADER -->
								<!-- PROFILE DETAIL -->
								<div class="profile-detail">
									<div class="profile-info">
										...
										<%
										ResultSet rs =stm.executeQuery("select * from travel.user where Name = 'operation'");
										rs.next();
										%>
							...
							<div class="profile-right">
								...
								<div class="awards">
									...
									<table class="table">
										...
										<%
										rs =stm.executeQuery("select * from travel.message where message.to = 'operation'");
				...
				<form action = "UploadOrder?method=operation" method="post" onsubmit="return formsubmit(this)">
					<div class="panel-body">
						...
						<label class="fancy-radio">
							<input name="state" value="After tour" type="radio">
								<span><i></i>After tour</span>
						</label>
						<label class="fancy-radio">
							<input name="state" value="Before tour" type="radio">
				...
				<div class="panel">
					<div class="panel-heading">
						<h3 class="panel-title">History Orders</h3>
					</div>
					<div class="panel-body">
						<table class="table table-bordered">
							<thead>
							...
							<tbody>
							<%
								list = WaitingPurchasingList.returnOrderList(true);
								for(String s:list){
							%>
											<tr><%String[] ss = s.split("#"); %>
												<td><%=ss[0] %></td>
