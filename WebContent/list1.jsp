					...
					<div class="panel panel-headline">
						<div class="panel-body">						
							<h3>Product or Service</h3>		
								<p class="lead">new_pro_1</p>
							<hr>					
							<h3>Tour Package</h3>
								<p class="lead">new_pack_1</p>
							<hr>					
							<h3>Automatic Comment</h3>
								<div class="alert alert-success alert-dismissible" role="alert">
								<i class="fa fa-check-circle"></i> RELIABLE
								</div>
							<hr>			
							<h3>Overall Report</h3>		
								<button type="button" class="btn btn-success">feel great</button>
								<button type="button" class="btn btn-success">enjoy</button>
								<button type="button" class="btn btn-success">outstanding</button>
								<button type="button" class="btn btn-success">pleasant experience</button>				
								<button type="button" class="btn btn-info">OK</button>
								<button type="button" class="btn btn-info">suitable</button>
								<button type="button" class="btn btn-warning">dizzy</button>
							<hr>		
								...
								<div class="panel-body">
									<table class="table">
										...
										<tbody>											
											...
											<tr>
												<td>uncomfortable/dizzy/awful</td>
												<td>1</td>
												<td>Negative</td>
											</tr>
										</tbody>
							...
							<p><a href="UserFeedBack.jsp">Feedbacks from Area A store in package_3 on 2010-03-03</a></p>	
							<p><a href="">Feedbacks from Area B store in package_3 on 2010-02-28</a></p>
							<p><a href="">Feedbacks from Area A store in package_3 on 2010-02-28</a></p>		
