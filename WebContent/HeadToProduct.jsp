	...
	<div id="wrapper">
		...
		<div class="main">
			...
			<div class="tab-content">
				...
				<div class="container-fluid">
					<h3 class="page-title">Instruction from Headquarters</h3>
					<div class="panel panel-headline">
						<div class="panel-body">						
							<h3>Topic</h3>		
								<p class="lead">New instruction for product control</p>
							<hr>					
							<h3>Time</h3>
								<p class="lead">2010-04-01</p>
							<hr>					
							<h3>Key Words</h3>
								<p class="lead">strict evaluation, focus on inventory</p>
							<hr>			
							<h3>Content</h3>		
