			...
			<div class="tab-content">
							...
							<div class="profile-left">
								...
								<div class="profile-header">
									...
									<div class="profile-main">
										<img src="assets/img/pig.png" class="img-circle" alt="Avatar">
								...
								<div class="profile-detail">
									<div class="profile-info">
										...
										<%
										ResultSet rs =stm.executeQuery("select * from travel.user where Name = 'customer'");
										rs.next();
										%>
							...
							<div class="profile-right">
								...
								<div class="awards">
									...
									<table class="table">
										...
										<%
										rs =stm.executeQuery("select * from travel.message where message.to = 'customer'");
				...
				<div class="panel">
					<div class="panel-heading">
						<h3 class="panel-title">Feedback collected from Internet written by customers in 7 days</h3>
					</div>
					<div class="panel-body">
						...
						<div class="text-center"><a href="#" class="btn btn-default">See history feedback</a></div>						
					</div>
				</div>
				</div>
