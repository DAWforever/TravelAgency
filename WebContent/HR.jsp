		...
		<div class="main">
			...
			<div class="tab-content">
							...
							<div class="profile-left">
								...
								<div class="profile-header">
									...
									<div class="profile-main">
										<img src="assets/img/bird.png" class="img-circle" alt="Avatar">
										<h3 class="name">HR</h3>
									</div>
								</div>
								<!-- END PROFILE HEADER -->
								...
								<div class="profile-detail">
									<div class="profile-info">
										...
										<%
										ResultSet rs =stm.executeQuery("select * from travel.user where Name = 'HR'");
										rs.next();
										%>
							...
							<div class="profile-right">
								...
								<div class="awards">
									...
									<table class="table">
										...
										<%
										ResultSet rs3 =stm.executeQuery("select * from travel.message where message.to = 'HR'");
										
										%>
										<tbody><%while(rs3.next()) {%>
											<tr>
												<td><%=rs3.getString("from") %></td>
				...
				<form action = "CommentUpdate?method=hr" method="post" onsubmit="return formsubmit(this)">
					<div class="panel">
					<div class="panel-heading">
						<h3 class="panel-title">Give Commetn on Staff</h3>
					</div>
					<div class="panel-body">
						<table class="table table-bordered">
							<thead>
