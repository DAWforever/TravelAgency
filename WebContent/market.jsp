	...
	<div id="wrapper">
					...
					<ul class="nav navbar-nav navbar-right">
						<li class="dropdown">
							...
							<ul class="dropdown-menu notifications">
								<li><a href="PurchasingList.jsp" class="notification-item"><span class="dot bg-warning"></span>New instruction from GM</a></li>
		...
		<div id="sidebar-nav" class="sidebar">
			<ul class="nav" role="tablist">
				...
				<li><a href="#tab-bottom-left4" role="tab" data-toggle="tab">View Current Propaganda Strategy</a></li>
							...
							<div class="profile-left">
								...
								<div class="profile-header">
									...
									<div class="profile-main">
										<img src="assets/img/shark.png" class="img-circle" alt="Avatar">
										<h3 class="name">market</h3>
									</div>
								</div>
								<!-- END PROFILE HEADER -->
								<!-- PROFILE DETAIL -->
								<div class="profile-detail">
									<div class="profile-info">
										...
										<%
										ResultSet rs =stm.executeQuery("select * from travel.user where Name = 'market'");
										rs.next();
										%>
							...
							<div class="profile-right">
								...
								<div class="awards">
									...
									<table class="table">
										...
										<%
										rs =stm.executeQuery("select * from travel.message where message.to = 'market'");
								...
								<div class="panel-body">
									<table class="table table-bordered">
										...
										<tbody>
											...
											<tr>
												<td><a href="StoreMarket.jsp">Area A Store</a></td>
												<td>Western Europe, the US, Beijing</td>
												<td>South East Asia, Taiwan</td>	
												<td><a href="AMarketRecommend.jsp">details</a></td>											
											</tr>
											<tr>
												<td><a href="StoreMarket.jsp">Area B Store</a></td>
												<td>Japan, Taiwan, HK, Macao</td>
												<td>Korea, South East Asia</td>
												<td><a href="">details</a></td>														
											</tr>
											<tr>
												<td><a href="StoreMarket.jsp">Area C Store</a></td>
												<td>South East Asia, Sanya, Taiwan</td>
												<td>Europe, the US</td>				
												<td><a href="">details</a></td>										
											</tr>
											<tr>
												<td><a href="StoreMarket.jsp">Area D Store</a></td>
				...
				<form action = "PlanUpdate?method=market" method="post" onsubmit="return formsubmit(this)">
					<div class="panel-body">
						...
						<select name="priority" class="form-control">
										<option value="middle">ALL</option>
				...
				<div class="panel">
								...
								<div class="panel-body">
									<table class="table table-bordered">
										...
										ResultSet rst = st.executeQuery("SELECT * FROM travel.plan WHERE plan.label='market'");
										while(rst.next()){
										%>
											<tr>
												<td><%=rst.getString("topic") %></td>
												<td><%String b=rst.getString("topic");if(b.contains("to")){ %><%="Area A store" %> <% } else { %> <%="ALL" %> <%} %></td>
