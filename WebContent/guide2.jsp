	...
	<div id="wrapper">
			...
			<div class="container-fluid">
				...
				<div id="navbar-menu">
					<ul class="nav navbar-nav navbar-right">
						...
						<li class="dropdown">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown"><span>guide2</span> <i class="icon-submenu lnr lnr-chevron-down"></i></a>
		...
		<div class="main">
			...
			<div class="tab-content">
							...
							<div class="profile-left">
								...
								<div class="profile-header">
									...
									<div class="profile-main">
										<img src="assets/img/snake.png" class="img-circle" alt="Avatar">
										<h3 class="name">guide2</h3>
									</div>
								</div>
								<!-- END PROFILE HEADER -->
								<!-- PROFILE DETAIL -->
								<div class="profile-detail">
									<div class="profile-info">
										...
										<%
										ResultSet rs =stm.executeQuery("select * from travel.user where Name = 'guide2'");
										rs.next();
										%>
							...
							<div class="profile-right">
								...
								<div class="awards">
									...
									<table class="table">
										...
										<%
										rs =stm.executeQuery("select * from travel.message where message.to = 'guide2'");
				...
				<form action = "ProductSendMessage?method=guide2	" method="post" onsubmit="return formsubmit(this)">
					<div class="panel-body">
