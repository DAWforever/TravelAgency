				...
				<div class="container-fluid">
					...
					<div class="panel panel-headline">
						<div class="panel-body">						
							...
							<hr>					
							<h3>Customer's Consuming Habits</h3>
								<p class="lead">Buying luxuries, high-level shopping</p>
							<hr>	
							<h3>Customer's Preferences Destinations</h3>
								<p class="lead">Western Europe, the US</p>
							<hr>				
							<h3>Statistical Report</h3>		
								...
								<div class="alert alert-success alert-dismissible" role="alert">
								<i class="fa fa-check-circle"></i> high-level consuming increase 
								</div>
								...
								<div class="alert alert-warning alert-dismissible" role="alert">
									<i class="fa fa-warning"></i> cheap tour package sales decrease
								</div>
							<hr>		
							<h3>History Information</h3>
							<p><a href="UserFeedBack.jsp">Feedbacks of area A store from 2010-01-01 to 2010-01-31</a></p>	
							<p><a href="">Customer orders of area A store from 2010-01-01 to 2010-01-31</a></p>
							<p><a href="">Sales of area A store from 2010-01-01 to 2010-01-31</a></p>		
							<hr>
						</div>
					</div>
				</div>
